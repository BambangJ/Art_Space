...
private fun ArtSpace() {
    ...
    when (artworkIndex) {
        0 -> {
            artwork = R.drawable.luffy_gear_5
            artworkDescription = R.string.anime__luffy_description
            artworkName = R.string.anime__luffy_title
            artworkReleaseYear = R.string.Chapter
            artworkGenre = R.string.enemy__luffy
        }
        1 -> {
            artwork = R.drawable.zoro_banner
            artworkDescription = R.string.anime__zoro_description
            artworkName = R.string.anime__zoro_title
            artworkReleaseYear = R.string.Chapter
            artworkGenre = R.string.enemy__zoro
        }
        2 -> {
            artwork = R.drawable.sanji_banner
            artworkDescription = R.string.anime_sanji_description
            artworkName = R.string.anime__sanji_title
            artworkReleaseYear = R.string.Chapter
            artworkGenre = R.string.escape__sanji

        }
        else -> {
            artwork = R.drawable.usop_banner
            artworkDescription = R.string.anime__ussop_description
            artworkName = R.string.anime__ussop_title
            artworkReleaseYear = R.string.Chapter
            artworkGenre = R.string.escape__ussop
        }
    }
